...
Runs the full 2-step pipeline (omega/period calibration -> convex) on a 
NEW object you do NOT have ground truth for, using
config_calibrate_unknown.yaml / config_convex_unknown.yaml 
(edit those first -- see the comments in each,
...
SCRATCH_DIR = SCRIPT_DIR / "configs_unknown" / "scratch"    # generated (period/checkpoint-filled) configs go here
...
def main():
    ...
    print("\n### STEP 1/2: omega/period calibration ###")
    ...
    print("\n### STEP 2/2: convex-stage reconstruction ###")
    ...
    print(f"\n{'=' * 80}\nDONE. Final reconstruction: {convex_cfg_path / 'final_mesh.stl'}\n{'=' * 80}")
